...
| Onda 4 | 21/06 – 22/06/2026 | Visualização interativa, análise, relatório e entrega final |
...
| **4** | 21/06/2026 | 22/06/2026 | Finalizar `analysis.py`, `main.py` e a camada `frontend/`; gerar os bundles compactos da visualização quando os dados estiverem disponíveis; consolidar a navegação por comunidades, comentários, sentenças e palavras; garantir fallback funcional com mocks/fixtures quando os bundles ainda não existirem; elaborar os slides da apresentação final; realizar a última atualização obrigatória no GitHub. | US14, US15, US16, US17, US18, US19, US20 | `frontend/` funcional com visão inicial de comunidades, drill-down, busca, filtros, painel lateral e modo de fallback com dados simulados; `main.py` executável de ponta a ponta; relatório de análise com tópicos, termos centrais e métricas; slides da apresentação final elaborados; **última atualização no GitHub até 22/06/2026 às 23h59**. |
...
| 21/06/2026 | Bundles de visualização, shell do frontend e fallback com mocks validados | A interface não consegue iniciar sem dados, layout base ou modo de contingência |
...
| 22/06/2026 | 1.1 | Inclusão da camada de visualização interativa e ajuste da onda final para integrar frontend, bundles e análise | Codex |
